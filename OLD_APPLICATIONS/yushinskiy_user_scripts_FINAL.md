...
### [ Сценарий 0 - Авторизация пользователя ]
1. Пользователь вводит свой логин/пароль
2. Если логин-пароль неверен, выводится ошибка с просьбой ещё раз проверить правильность их написания, а так же отправляется сообщение о попытке входа на привязаннную к аккаунту обладателя логина почту о попытке входа
3. Если логин-пароль верен, переходим к Сценарию 2
...
10. Пользователь вводит почту, которую он хочет привязать к аккаунту
10. Если пользователь потверждает верность информации, на введенную почту лицеиста с с этим именем приходит сообщение с ссылкой на подтверждение того что зарегистрироваться пытается именно он
...
14. Если второй логин уже занят, система даёт рекомендации по придумыванию уникального логина
...
### [ Сценарий 8 - Всегда рядом ]
0. Этот сценарий открыт при работе Сцеариев 2, 2.2, 5, 7
1. Возможность выйти из аккаунта
2. Возможность отменить все свои голоса за идущее голосование
3. Возможность перейти к Сценариям 2, 2.2, 5, 7
